...
namespace CodeStage.AntiCheat.ObscuredTypes.Converters
{
	...
	public class ObscuredTypesNewtonsoftConverter : JsonConverter 
	{
        ...
        private HashSet<int> _obscuredTypeHashSet = new HashSet<int>();
        private HashSet<int> _otherTypeHashSet = new HashSet<int>();
        ...
        public override bool CanConvert(Type objectType)
        {
	        ...
	        var typeHashCode = objectType.GetHashCode();
	        if (_obscuredTypeHashSet.Contains(typeHashCode))
	        {
		        return true;
	        }
	        else
	        {
		        if(_otherTypeHashSet.Contains(typeHashCode))
			        return false;
		        
		        var isInTypes = types.Any(t => t == objectType);
		        if (isInTypes)
		        {
			        _obscuredTypeHashSet.Add(typeHashCode);
			        return true;
		        }
		        else
		        {
			        _otherTypeHashSet.Add(typeHashCode);
			        return false;
		        }
	        }
        }
