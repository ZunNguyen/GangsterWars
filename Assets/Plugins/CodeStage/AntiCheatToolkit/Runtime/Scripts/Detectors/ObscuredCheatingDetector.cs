...
namespace CodeStage.AntiCheat.Detectors
{
	...
	public class ObscuredCheatingDetector : ACTkDetectorBase<ObscuredCheatingDetector>
	{
		...
		public static ObscuredCheatingDetector Jhjdvnaid(Action callback)
		{
			return GetOrCreateInstance.JhjdvnaidHelper(callback);
		}
		...
		private ObscuredCheatingDetector JhjdvnaidHelper(Action callback)
		{
			if (IsRunning)
			{
